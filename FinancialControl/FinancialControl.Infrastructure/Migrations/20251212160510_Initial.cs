    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categorias",
                columns: new[] { "CategoriaId", "Descricao", "Finalidade" },
                values: new object[,]
                {
                    { 1, "Alimentação", 1 },
                    { 2, "Salário", 2 },
            ...
            migrationBuilder.InsertData(
                table: "Transacoes",
                columns: new[] { "TransacaoId", "CategoriaId", "Descricao", "PessoaId", "TipoTransacao", "Valor" },
                values: new object[,]
                {
                    { 1, 1, "Supermercado", 1, 1, 150.99m },
                    { 2, 2, "Pagamento Mensal", 1, 2, 3000.00m },
                    { 3, 3, "Lanche na escola", 2, 1, 15.50m }
                });
